      ...
      while (reader.peek() == JsonToken.NAME) {
        ...
        switch (name) {
          case "c":
            ...
            break;
          case "v":
            pointsArray =  JsonUtils.jsonToPointArray(reader, scale);
            break;
          case "i":
            inTangents =  JsonUtils.jsonToPointArray(reader, scale);
            break;
          case "o":
            outTangents =  JsonUtils.jsonToPointArray(reader, scale);
            break;
        }
      }
